...
{(profile.userType==='Buyer')?
<li class="nav-item"><a href="./profileBuyer" class="nav-link"><i  class="ion-ios-person pr-2"/>Profile</a></li>:<li class="nav-item"><a href="./profile" class="nav-link"><i  class="ion-ios-person pr-2"/>Profile</a></li>}
